...
const Services = () => {
  return (
    <div className="relative container py-20 md:py-28 text-[#151615] bg-white md:bg-onyx-grey space-y-8 md:space-y-20 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-center space-y-8 md:space-x-0 z-10 relative">
        <div className="flex-1 flex flex-col justify-center items-center space-y-4">
          ...
          <p className="text-center">
            Buy and sell cryto from company to <br /> user and Vise-versa
          </p>
        </div>
        <div className="flex-1 flex flex-col justify-center items-center space-y-4">
